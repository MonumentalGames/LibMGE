...
def IMG_isAVIF(src) -> bool: return bool(IMAGEFunc("IMG_isAVIF", [_P(SDL_RWops)], c_int)(src))
def IMG_isICO(src) -> bool: return bool(IMAGEFunc("IMG_isICO", [_P(SDL_RWops)], c_int)(src))
def IMG_isCUR(src) -> bool: return bool(IMAGEFunc("IMG_isCUR", [_P(SDL_RWops)], c_int)(src))
def IMG_isBMP(src) -> bool: return bool(IMAGEFunc("IMG_isBMP", [_P(SDL_RWops)], c_int)(src))
def IMG_isGIF(src) -> bool: return bool(IMAGEFunc("IMG_isGIF", [_P(SDL_RWops)], c_int)(src))
def IMG_isJPG(src) -> bool: return bool(IMAGEFunc("IMG_isJPG", [_P(SDL_RWops)], c_int)(src))
def IMG_isJXL(src) -> bool: return bool(IMAGEFunc("IMG_isJXL", [_P(SDL_RWops)], c_int)(src))
def IMG_isLBM(src) -> bool: return bool(IMAGEFunc("IMG_isLBM", [_P(SDL_RWops)], c_int)(src))
def IMG_isPCX(src) -> bool: return bool(IMAGEFunc("IMG_isPCX", [_P(SDL_RWops)], c_int)(src))
def IMG_isPNG(src) -> bool: return bool(IMAGEFunc("IMG_isPNG", [_P(SDL_RWops)], c_int)(src))
def IMG_isPNM(src) -> bool: return bool(IMAGEFunc("IMG_isPNM", [_P(SDL_RWops)], c_int)(src))
def IMG_isSVG(src) -> bool: return bool(IMAGEFunc("IMG_isSVG", [_P(SDL_RWops)], c_int)(src))
def IMG_isQOI(src) -> bool: return bool(IMAGEFunc("IMG_isQOI", [_P(SDL_RWops)], c_int)(src))
def IMG_isTIF(src) -> bool: return bool(IMAGEFunc("IMG_isTIF", [_P(SDL_RWops)], c_int)(src))
def IMG_isXCF(src) -> bool: return bool(IMAGEFunc("IMG_isXCF", [_P(SDL_RWops)], c_int)(src))
def IMG_isXPM(src) -> bool: return bool(IMAGEFunc("IMG_isXPM", [_P(SDL_RWops)], c_int)(src))
def IMG_isXV(src) -> bool: return bool(IMAGEFunc("IMG_isXV", [_P(SDL_RWops)], c_int)(src))
def IMG_isWEBP(src) -> bool: return bool(IMAGEFunc("IMG_isWEBP", [_P(SDL_RWops)], c_int)(src))
